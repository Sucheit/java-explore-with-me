...
public class EventServiceImpl implements EventService {
    ...
    private void patchEventFields(Event event, UpdateEventAdminRequest updateEventAdminRequest) {
        ...
        ru.practicum.admin.dto.StateAction stateAction = updateEventAdminRequest.getStateAction();
        if (stateAction != null) {
            if (stateAction.equals(ru.practicum.admin.dto.StateAction.PUBLISH_EVENT)) {
            ...
            if (stateAction.equals(ru.practicum.admin.dto.StateAction.REJECT_EVENT)) {
